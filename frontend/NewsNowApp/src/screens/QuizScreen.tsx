...
const styles = StyleSheet.create({
  ...
  difficultyBadge: { backgroundColor: '#F3F4F6', paddingHorizontal: 12, paddingVertical: 7, borderRadius: 999 },
  difficultyBadgeText: { color: '#4B5563', fontSize: 13, fontWeight: '700' },
